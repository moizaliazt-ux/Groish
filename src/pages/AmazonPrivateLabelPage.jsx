        ...
        <div className="lg:col-span-2 space-y-12">
          <section>
            ...
            <p className="text-slate-600 leading-relaxed mb-4">
              Building a brand on Amazon is the most lucrative long-term business model. The {course.title} provides you with exact strategies to find high-demand, low-competition products and launch them successfully.
            </p>
            <p className="text-slate-600 leading-relaxed">
              In this {course.duration} course, learn from industry experts on how to source from China, create optimized listings, and utilize Amazon PPC to rank your products on the first page.
            </p>
          </section>
...
export default AmazonPrivateLabelPage;